...
public class Help extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println(" <link HREF=\"" + Constants.getServerName(c_con) + "resources/egenStyler_public.css\"  REL=\"stylesheet\" TYPE=\"text/css\" >");
            ...
            out.println("<p>  <a href=\"" + Constants.getServerRoot(c_con) + "egenvar_admin_manual.pdf\">Administrators manual</a></p>\n"
                    + "        <p><a href=\"" + Constants.getServerName(c_con) + "Command_line_Tutorial.pdf\">Command line tool tutorial</a></p>");
            out.println("</body>");
            out.println("</html>");
